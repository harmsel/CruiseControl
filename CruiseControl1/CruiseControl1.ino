...
const float correctieVertragen = 1.2;  // als de snelheid te hoog is is dit de snelheid van correctie
const int hysteresis = 1;              // Als pulsMeting +1 of -1  afwijkt van histeresis, dan corrigeren
